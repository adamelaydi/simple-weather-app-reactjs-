...
export default async function GetWeather(city){
    ...
    const URL =`https://api.open-meteo.com/v1/forecast?latitude=${coords.lat}&longitude=13.41&daily=temperature_2m_max,temperature_2m_min&current=temperature_2m,weather_code`
    await axios.get(, {
    })
    .then((response) => {
