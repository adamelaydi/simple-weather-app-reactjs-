...
export default async function GetWeather(city){
    ...
    aaxios.get("https://api.open-meteo.com/v1/forecast?latitude=52.52&longitude=13.41&daily=temperature_2m_max,temperature_2m_min&current=temperature_2m,weather_code", {
    })
    .then((response) => {
