...
export default async function GetWeather(city){
    ...
    const coords= {lon:city.longitude,lat:city.lattitude}
    // API URL
    const URL =`https://api.open-meteo.com/v1/forecast?latitude=${coords.latitude}&longitude=${coords.longitude}&daily=temperature_2m_max,temperature_2m_min&current=temperature_2m,weather_code`
