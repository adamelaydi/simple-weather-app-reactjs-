...
export default async function GetWeather(city){
    ...
    // API URL
    const URL =`https://api.open-meteo.com/v1/forecast?latitude=${coords.latit}&longitude=${coords.lon}&daily=temperature_2m_max,temperature_2m_min&current=temperature_2m,weather_code`
